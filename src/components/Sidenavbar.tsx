    ...
    return (
        // <div className="left-0">
            <Sheet>
                ...
                <Link href="/user" className={`flex h-10 items-center justify-center rounded-full px-4 text-center text-sm transition-colors hover:text-primary ${pathname == "/user" ? 'bg-muted font-medium text-primary' : 'text-muted-foreground'}`}>User</Link>
