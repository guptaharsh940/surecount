...
export function Sidenavbar(session: any) {
        ...
        <Sheet>
            ...
            <SheetContent side="left">
                <div className="mt-7">
                    ...
                    {session?.user?.userType == "Admin" && <Link href="/user" className={`flex h-10 items-center justify-center rounded-full px-4 text-center text-sm transition-colors hover:text-primary ${pathname == "/user" ? 'bg-muted font-medium text-primary' : 'text-muted-foreground'}`}>User</Link>}
